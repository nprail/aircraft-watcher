...
async function processPoll() {
  ...
  for (const ac of aircraft) {
    try {
      ...
      const cycleKey = ac.hex || ac.r || ac.registration || ac.tail || ac.flight || ac.callsign || JSON.stringify(ac);
      ...
      logger.error('Error processing aircraft', { error: acErr.message, aircraft: ac });
    }
  }
}
